            ...
            if (Test-Path $queuePath) {
                ...
                if ($queueData -and $queueData.Count -gt 0) {
                    ...
                    if ($queuePrompt) {
                        ...
                        if ($queuePrompt.IncludeClipboard) { $prompt.IncludeClipboard = $queuePrompt.IncludeClipboard }
                        ...
                        Write-Host "Include Clipboard: $($prompt.IncludeClipboard)" -ForegroundColor Cyan
